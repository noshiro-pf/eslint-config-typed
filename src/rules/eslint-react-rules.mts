...
export const eslintReactRules: EslintReactRules = {
  ...
  /**
   * Avoid writing strings directly in JSX, enforce using `<div>{"aaa"}</div>` format.
   * Benefits: Easier to catch missing `{}` around variables, better syntax highlighting for readability.
   */
  ...
  /** Avoid `{...props}` spread as it weakens type checking for props excess/shortage */
